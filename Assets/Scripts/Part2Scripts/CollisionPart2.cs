...
public class CollisionPart2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float groundPosX = ground.transform.position.x;
        float groundPosY = ground.transform.position.y;
        float groundHeight = ground.transform.localScale.x;
        float groundWidth = ground.transform.localScale.y;
